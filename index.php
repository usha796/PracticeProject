    ...
    <div class="hero-wrap js-fullheight" style="background-image: url('images/jobs.jpg');" data-stellar-background-ratio="0.5">
			          ...
			          <div class="col-md-12 tab-wrap">
			            ...
			            <div class="tab-content p-4" id="v-pills-tabContent">
			              ...
			              <div class="tab-pane fade show active" id="v-pills-1" role="tabpanel" aria-labelledby="v-pills-nextgen-tab">
			              	<form action="about.php" method="post" class="search-job">
			              		<div class="row">
			              			<div class="col-md">
			              				<div class="form-group">
				              				<div class="form-field">
				              					<div class="icon"><span class="icon-briefcase"></span></div>
								                <input type="text" name="keyword" id="keyword" class="form-control" placeholder="eg. Fullstack Developer">
								              </div>
							              </div>
			              			</div>
			              			<div class="col-md">
...
$sql=mysqli_query($conn, "select* from all_jobs LEFT JOIN company ON all_jobs.employee_email=company.admin WHERE keyword LIKE '%$keyword%' OR category='$category' ");
}
?>
<div id="id_all_jobs">
            ...
            <div class="job-post-item bg-white p-4 d-block d-md-flex align-items-center">
              ...
              <div class="mb-4 mb-md-0 mr-5">
                ...
                <div class="job-post-item-body d-block d-md-flex">
                  ...
                  <div><span class="icon-my_location"></span> <span><?php echo $row['country'];?>, <?php echo $row['city'];?></span></div>
                </div>
              </div>

              <div class="ml-auto d-flex">
                <a href="job_single.php?id=<?php echo $row['job_id']; ?>" class="btn btn-primary py-2 mr-1">Apply Job</a>
            ...
            <div class="carousel-testimony owl-carousel ftco-owl">
              <div class="item">
                <div class="testimony-wrap py-4 pb-5">
                  <div class="user-img mb-4" style="background-image: url(images/img1.jpg)">
              ...
              <div class="item">
                <div class="testimony-wrap py-4 pb-5">
                  <div class="user-img mb-4" style="background-image: url(images/image3.jpg)">
                    <span class="quote d-flex align-items-center justify-content-center">
                      <i class="icon-quote-left"></i>
                    </span>
                  </div>
              ...
              <div class="item">
                <div class="testimony-wrap py-4 pb-5">
                  <div class="user-img mb-4" style="background-image: url(images/imgage4.jpg)">
                    <span class="quote d-flex align-items-center justify-content-center">
                      <i class="icon-quote-left"></i>
                    </span>
                  </div>
              ...
              <div class="item">
                <div class="testimony-wrap py-4 pb-5">
                  <div class="user-img mb-4" style="background-image: url(images/image2.jpg)">
                    <span class="quote d-flex align-items-center justify-content-center">
                      <i class="icon-quote-left"></i>
                    </span>
                  </div>
          ...
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
            	...
            	<div class="block-23 mb-3">
	              <ul>
	                <li><span class="icon icon-map-marker"></span><span class="text">Newroard, Near New Road Gate,Kathmandu</span></li>
	                <li><a href="#"><span class="icon icon-phone"></span><span class="text">01-4456789</span></a></li>
	                <li><a href="#"><span class="icon icon-envelope"></span><span class="text">kamrmahotel@gmail.com</span></a></li>
	              </ul>
	            </div>
            </div>
          </div>
