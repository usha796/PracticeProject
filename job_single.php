...
if(isset($_SESSION['email']) && !empty($_SESSION['email'])) {
  ...
  header('Location: job_post.php'); // Redirect to the login page
  exit(); 
}
?>
	  ...
	  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
            ...
            <li class="nav-item active"><a class="nav-link" href="#" style="font-weight: bold; color: #5DADE2;"><?php echo $_SESSION['email']; ?></a></li>
...
$query=mysqli_query($conn,"select* from all_jobs where job_id='$id'  ");
 ...
 // $email=$row['email'];
  $id_job=$row['job_id'];
    ...
    ?>
    <div class="hero-wrap js-fullheight" style="background-image: url('images/background.jpg');" data-stellar-background-ratio="0.5">
      <div class="overlay"></div>
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-start" data-scrollax-parent="true">
          <div class="col-md-8 ftco-animate text-center text-md-left mb-5" data-scrollax=" properties: { translateY: '70%' }">
          	<p class="breadcrumbs" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><span class="mr-3"><a href="index.php">Home <i class="ion-ios-arrow-forward"></i></a></span> <span class="mr-3"><a href="blog.php">Jobs<i class="ion-ios-arrow-forward"></i></a></span> <span>Single</span></p>
            <h1 class="mb-3 bread" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Jobs</h1>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-8 ftco-animate">
            ...
            <div class="row">
             <div class="col-sm-6">
            <label for="">Enter Your Conatct number</label>
            ...
            <input type="text" class="form-control" value="<?php echo $_SESSION['email']; ?>">
             ...
             <input type="Submit" name="submit" value="Submit" class="bt btn-primary " >
             </div>
          </form>
